...
if __name__ == '__main__':
    ...
    alignment_512_pd = pd.read_csv('alignment-512.csv')
    alignment_512_data = alignment_512_pd['Gflops'].to_numpy()
    ...
    plt.plot(index, alignment_data, label='block_size=64, alignment', color='pink', marker='x', linestyle='--')
    plt.plot(index, alignment_512_data, label='block_size=512, alignment', color='brown', marker='x', linestyle='--')
    plt.plot(index, alignment_reset_data_68, label='block_size=68, alignment_reset', color='gray', marker='x', linestyle='--')
    plt.plot(index, alignment_reset_data_260, label='block_size=260, alignment_reset', color='olive', marker='x', linestyle='--')
    plt.plot(index, alignment_reset_data_516, label='block_size=516, alignment_reset', color='cyan', marker='x', linestyle='--')
