                                              ...
                                              int halo_x, int halo_y, int halo_z)
{
    ...
    if (tx < nx && ty < ny && tz < nz)
    {
        ...
        offset_x = (local_x == 1) ? -1 : (local_x == BLOCK_X) ? 1
                                                              : 0;
        offset_y = (local_y == 1) ? -1 : (local_y == BLOCK_Y) ? 1
                                                              : 0;
        offset_z = (local_z == 1) ? -1 : (local_z == BLOCK_Z) ? 1
                                                              : 0;
